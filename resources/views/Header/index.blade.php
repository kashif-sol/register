...
<header class="header header-nav-menu header-nav-links" style="background:#f6f6f7;border: none;">
				...
				<div class="header-right">
					...
					<div id="userbox" class="userbox">
						<a href="#" data-bs-toggle="dropdown">
							...
							<span class="profile-picture profile-picture-as-text"> @if(isset($retdashboard)) {{$retdashboard->first_name}} @else JD @endif</span>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a  href="{{ route('logout') }}" ><i class="bx bx-lock-open-alt"></i> LogOut
